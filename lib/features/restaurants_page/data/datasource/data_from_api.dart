...
class DataFromApiForResraurent {
  ...
  Future<List<RestaurantModel>> getFastFoodDetail(String stateName) async {
    final query = _buildQuery(stateName, "fast_food");
  ...
  Future<List<RestaurantModel>> getFoodCourtDetail(String stateName) async {
    final query = _buildQuery(stateName, "fast_court");
  ...
  Future<List<RestaurantModel>> _parseRestaurant(
    Map<String, dynamic> data,
  ) async {
    final List elements = data['elements'] ?? [];

    // Map JSON array elements safely to your RestaurantModel list
    final List<RestaurantModel> restaurants = elements.map((element) {
      // Ensure your RestaurantModel has a robust fromJson/fromMap constructor
  ...
  _buildQuery(String stateName, String amenity) {
